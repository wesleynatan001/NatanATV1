...
<!-- <iframe style="float: left; margin-left: 80px;" ></iframe> -->
	...
	<div id="titulo">Em Manunteção  </div>
<br>	
 	<p style="text-align: center; margin-bottom: 300px"><b> Voltaremos em Breve. Estamos trabalhando para melhorar sua expericia em nossas plataformas.</b></p>
